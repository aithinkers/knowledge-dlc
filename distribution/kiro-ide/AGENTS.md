...
["node", "distribution/kiro-ide/run.mjs", <operation>, "--output", "json", ...args]
directly without a shell. Supported operations: init, setup, adopt, ingest, query, proposal, review, publish, status, lint, refresh, trace, conflicts, gaps, migrate, doctor, reconcile-edits, jobs, sources.
