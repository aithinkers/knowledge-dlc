...
directly without a shell. Supported operations: init, adopt, ingest, query, proposal, review, publish, status, lint, refresh, trace, conflicts, gaps, migrate, doctor, reconcile-edits, jobs.
