...
Use the source-analyst when a document has been ingested and you need what
it actually says turned into checkable claims — each one pinned to the exact
source, version, and location it came from.

## Working with it

Every claim it hands back tells you whether the source stated it outright,
...
From an ingested SLA document it extracts "API availability target is
