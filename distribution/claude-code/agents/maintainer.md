...
Use the maintainer for the health of what's already published: sources that
...
It reports findings as work you can review — refresh this, deprecate that,
...
A quarterly sweep finds the vendor API doc a concept relies on returns 404
