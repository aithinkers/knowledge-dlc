...
if (process.env.KDLC_RESTRICTED_WORKER !== "1" || !/^v(?:22|23|24)\./.test(process.version)) throw new Error("Restricted normalizer requires the supported Node 22-24 worker boundary");
