...
test("FEAT-006 governed packet, decision, and publication survive engine restart", async (t) => {
  ...
  policy.review_contexts.push({ workflow_id: "wf_ingest", context: {
    evidence: normalized_evidence.units.map((unit) => ({ source_id: normalized_evidence.source_id, source_hash: normalized_evidence.source_hash, locator: unit.locator, excerpt: unit.text, authority: "trusted:test", access: { classification: "public" }, rights: { license: "LicenseRef-Internal", redistribution: "prohibited", derivative_use: "allowed", commercial_use: "prohibited" }, extraction_quality: "deterministic", warnings: [] })),
